    ...
    return (
        <nav className="nav">
            ...
            <ul className="nav-list">
                {/* User can access Insert Data */}
                 {/* Ninew to ten เปลี่ยนเป็น ViewCourseInfo นะ */}
                {(role === "user" || role === "Curriculum Admin") && (
                    <CustomLink to="/Page">{t('Insert Data')}</CustomLink>
                )}

                {/* Student and Instructor can access Edit Data */}
                {/* Ninew to ten เปลี่ยนเป็น ViewChart นะ */}
